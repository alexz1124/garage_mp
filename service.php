          ...
          <section class="tabs-content">
            <article id="tabs-1">
              ...
              <div style="margin-bottom: 10px">
                <span>John Doe &nbsp;|&nbsp; 27.07.2020 10:10 &nbsp;|&nbsp; 15
                  comments</span>
              </div>
              <p>
          ...
          <ul>
            <li>
              <h5 style="margin-bottom: 10px">
                <a href="blog-details.html">Dolorum corporis ullam, reiciendis inventore est
                  repudiandae</a>
              </h5>
              <small><i class="fa fa-user"></i> John Doe &nbsp;|&nbsp;
            ...
            <li>
              <h5 style="margin-bottom: 10px">
                <a href="blog-details.html">Culpa ab quasi in rerum dolorum impedit expedita</a>
              </h5>
              <small><i class="fa fa-user"></i> John Doe &nbsp;|&nbsp;
                <i class="fa fa-calendar"></i> 27.07.2020 10:10</small>
            </li>
            ...
            <li>
              <h5 style="margin-bottom: 10px">
                <a href="blog-details.html">Explicabo soluta corrupti dolor doloribus optio dolorum</a>
              </h5>
