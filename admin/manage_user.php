                    ...
                    <table id="myTable">
                        ...
                        <?php while ($num = mysqli_fetch_array($result)) :
                            echo ("<tr>
                                    ...
                                    <td id = \"action\"><a href=#><i class=\"fas fa-edit\"></i></a> / <a href=#><i class=\"fas fa-trash\"></i></a></td>
                                </tr>");
                        endwhile ?>
                        ...
                        <tr id="52">
                            ...
                            <td id="t1">TEST</td>
                            <td id="t2">ALEX</td>
                            <td id="t3">0855555555</td>
                            <td id="t4">Admin</td>
                            <!-- <td id="t5"><button type="submit"><i class="fas fa-edit"></i></button> </td> -->
                            <!-- <td> <a href="form.php?name=" . $num[r_username] . "&id=" . $num[id]>EDIT</a></td> -->
                            <td> <a href="form.php?name=">EDIT</a></td>
                        </tr>
                    </table>
                </form>
